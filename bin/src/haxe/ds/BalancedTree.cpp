...
HX_LOCAL_STACK_FRAME(_hx_pos_2f7e1921f2cdd644_1_iteratorLoop,"haxe.ds.BalancedTree","iteratorLoop",0x3392c523,"haxe.ds.BalancedTree.iteratorLoop","?",1,0x0000003f)
namespace haxe{
namespace ds{
...
void BalancedTree_obj::iteratorLoop( ::haxe::ds::TreeNode node,::cpp::VirtualArray acc){
            	HX_STACKFRAME(&_hx_pos_2f7e1921f2cdd644_1_iteratorLoop)
HXDLIN(   1)		while(true){
HXLINE( 173)			if (::hx::IsNotNull( node )) {
HXLINE( 174)				::haxe::ds::BalancedTree_obj::iteratorLoop(node->left,acc);
HXLINE( 175)				acc->push(node->value);
HXLINE( 176)				node = node->right;
HXLINE(   1)				continue;
            			}
HXDLIN(   1)			return;
            		}
