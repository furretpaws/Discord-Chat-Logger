...
HX_LOCAL_STACK_FRAME(_hx_pos_d203511e47ccd6c9_92_add,"haxe.MainLoop","add",0xf65145d8,"haxe.MainLoop.add","C:\\HaxeToolkit\\haxe\\std/haxe/MainLoop.hx",92,0x949ef6b1)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(MainLoop_obj,hasEvents,return )
 ...
 ::haxe::MainEvent MainLoop_obj::add( ::Dynamic f,::hx::Null< int >  __o_priority){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d203511e47ccd6c9_92_add)
HXLINE(  93)		if (::hx::IsNull( f )) {
HXLINE(  94)			HX_STACK_DO_THROW(HX_("Event function is null",5b,98,d0,36));
            		}
HXLINE(  95)		 ::haxe::MainEvent e =  ::haxe::MainEvent_obj::__alloc( HX_CTX ,f,priority);
HXLINE(  96)		 ::haxe::MainEvent head = ::haxe::MainLoop_obj::pending;
HXLINE(  97)		if (::hx::IsNotNull( head )) {
HXLINE(  98)			head->prev = e;
            		}
HXLINE(  99)		e->next = head;
HXLINE( 100)		::haxe::MainLoop_obj::pending = e;
HXLINE( 101)		return e;
            	}
