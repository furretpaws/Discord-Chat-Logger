...
HX_DEFINE_STACK_FRAME(_hx_pos_9d9f724dcba0f141_36_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",36,0xc2abb812)
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_53_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",53,0xc2abb812)
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_67_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",67,0xc2abb812)
...
void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_36_new)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_53_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_67_get_message)
