...
HX_LOCAL_STACK_FRAME(_hx_pos_4ede4f7f368b7211_60_bitOR,"haxe.crypto.Md5","bitOR",0xbf34737b,"haxe.crypto.Md5.bitOR","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Md5.hx",60,0xa59e361e)
HX_LOCAL_STACK_FRAME(_hx_pos_4ede4f7f368b7211_66_bitXOR,"haxe.crypto.Md5","bitXOR",0x8eb76a23,"haxe.crypto.Md5.bitXOR","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Md5.hx",66,0xa59e361e)
HX_LOCAL_STACK_FRAME(_hx_pos_4ede4f7f368b7211_72_bitAND,"haxe.crypto.Md5","bitAND",0x8ea5f55f,"haxe.crypto.Md5.bitAND","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Md5.hx",72,0xa59e361e)
...
int Md5_obj::bitOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_4ede4f7f368b7211_60_bitOR)
HXDLIN(  60)		return (((::hx::UShr(a,1) | ::hx::UShr(b,1)) << 1) | ((a & 1) | (b & 1)));
            	}
...
int Md5_obj::bitXOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_4ede4f7f368b7211_66_bitXOR)
HXDLIN(  66)		return (((::hx::UShr(a,1) ^ ::hx::UShr(b,1)) << 1) | ((a & 1) ^ (b & 1)));
            	}
...
int Md5_obj::bitAND(int a,int b){
            	HX_STACKFRAME(&_hx_pos_4ede4f7f368b7211_72_bitAND)
HXDLIN(  72)		return (((::hx::UShr(a,1) & ::hx::UShr(b,1)) << 1) | ((a & 1) & (b & 1)));
            	}
...
HXLINE(  78)		return (((((x >> 16) + (y >> 16)) + (lsw >> 16)) << 16) | (lsw & 65535));
            	}
...
HXLINE(  39)		{
HXLINE(  39)			{
HXLINE(  40)				out->b[0] = ( (unsigned char)((h1->__get(0) & 255)) );
HXLINE(  41)				out->b[1] = ( (unsigned char)(((h1->__get(0) >> 8) & 255)) );
HXLINE(  42)				out->b[2] = ( (unsigned char)(((h1->__get(0) >> 16) & 255)) );
HXLINE(  43)				out->b[3] = ( (unsigned char)(::hx::UShr(h1->__get(0),24)) );
            			}
HXLINE(  39)			{
HXLINE(  40)				out->b[4] = ( (unsigned char)((h1->__get(1) & 255)) );
HXLINE(  41)				out->b[5] = ( (unsigned char)(((h1->__get(1) >> 8) & 255)) );
HXLINE(  42)				out->b[6] = ( (unsigned char)(((h1->__get(1) >> 16) & 255)) );
HXLINE(  43)				out->b[7] = ( (unsigned char)(::hx::UShr(h1->__get(1),24)) );
            			}
HXLINE(  39)			{
HXLINE(  40)				out->b[8] = ( (unsigned char)((h1->__get(2) & 255)) );
HXLINE(  41)				out->b[9] = ( (unsigned char)(((h1->__get(2) >> 8) & 255)) );
HXLINE(  42)				out->b[10] = ( (unsigned char)(((h1->__get(2) >> 16) & 255)) );
HXLINE(  43)				out->b[11] = ( (unsigned char)(::hx::UShr(h1->__get(2),24)) );
            			}
HXLINE(  39)			{
HXLINE(  40)				out->b[12] = ( (unsigned char)((h1->__get(3) & 255)) );
HXLINE(  41)				out->b[13] = ( (unsigned char)(((h1->__get(3) >> 8) & 255)) );
HXLINE(  42)				out->b[14] = ( (unsigned char)(((h1->__get(3) >> 16) & 255)) );
HXLINE(  43)				out->b[15] = ( (unsigned char)(::hx::UShr(h1->__get(3),24)) );
            			}
            		}
...
HXLINE(  97)		blks[((nblk * 16) - 1)] = 0;
HXLINE( 105)		int i = 0;
HXLINE( 106)		while((i < b->length)){
HXLINE( 107)			int index = (i >> 2);
HXDLIN( 107)			blks[index] = (blks->__get(index) | (( (int)(b->b->__get(i)) ) << ((((b->length << 3) + i) & 3) << 3)));
HXLINE( 108)			i = (i + 1);
            		}
HXLINE( 110)		int index1 = (i >> 2);
HXDLIN( 110)		blks[index1] = (blks->__get(index1) | (128 << (::hx::Mod(((b->length * 8) + i),4) * 8)));
HXLINE( 111)		int l = (b->length * 8);
HXLINE( 112)		int k = ((nblk * 16) - 2);
HXLINE( 113)		blks[k] = (l & 255);
HXLINE( 114)		blks[k] = (blks->__get(k) | ((::hx::UShr(l,8) & 255) << 8));
HXLINE( 115)		blks[k] = (blks->__get(k) | ((::hx::UShr(l,16) & 255) << 16));
HXLINE( 116)		blks[k] = (blks->__get(k) | ((::hx::UShr(l,24) & 255) << 24));
