...
HX_LOCAL_STACK_FRAME(_hx_pos_d9357d86f6a2fb2a_42_repeat,"sys.thread.EventLoop","repeat",0xe060da0e,"sys.thread.EventLoop.repeat","C:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",42,0x60c7a9aa)
HX_LOCAL_STACK_FRAME(_hx_pos_d9357d86f6a2fb2a_86_cancel,"sys.thread.EventLoop","cancel",0x9218302d,"sys.thread.EventLoop.cancel","C:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",86,0x60c7a9aa)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::_EventLoop::RegularEvent EventLoop_obj::repeat( ::Dynamic event,int intervalMs){
            	HX_GC_STACKFRAME(&_hx_pos_d9357d86f6a2fb2a_42_repeat)
...
void EventLoop_obj::cancel( ::sys::thread::_EventLoop::RegularEvent eventHandler){
            	HX_STACKFRAME(&_hx_pos_d9357d86f6a2fb2a_86_cancel)
