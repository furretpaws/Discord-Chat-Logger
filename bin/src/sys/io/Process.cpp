...
HX_LOCAL_STACK_FRAME(_hx_pos_213d55cc5cbbab8a_108_exitCode,"sys.io.Process","exitCode",0x41e72111,"sys.io.Process.exitCode","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",108,0x19dec630)
namespace sys{
namespace io{
...
bool Process_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Process_obj::exitCode(::hx::Null< bool >  __o_block){
            	...
            	HX_STACKFRAME(&_hx_pos_213d55cc5cbbab8a_108_exitCode)
